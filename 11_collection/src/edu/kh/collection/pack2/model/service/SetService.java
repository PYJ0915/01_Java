...
public class SetService {
	...
	public void method1() {
		...
		set.add(null); // TreeSet은 null 저장을 지원하지 않음 (자동정렬을 위해 compareTo() 메서드 이용 시 nullPointerException 예외 발생하기 때문)
		set.add(null);
		set.add(null);
		set.add(null);
		set.add(null);
		...
		// 3. boolean remove (E e) : 전달받은 인자 e를 Set에서 제거, 제거 성공 시 true 실패 시 false 반환
		
		System.out.println(set.remove("배달의 민족"));
		System.out.println(set);
		System.out.println(set.remove("다음"));
	...
	public void method2() {
		...
		// Iterator set.iterator() : 현재 Set을 순차접근할 수 있는 Iterator 객체 반환
	...
	public void method3() {
		...
		// - 같은 필드 값을 가진 객체는 해시코드번호가 같다
		System.out.println("p1: " + p1.hashCode());
		System.out.println("p2: " + p2.hashCode());
		System.out.println("p3: " + p3.hashCode());
		System.out.println("p4: " + p4.hashCode());
		
		// - A.equals(B) : A와 B가 가지고 있는 필드 값이 전부 같으면 true
	 ...
	 * 	-> 컬렉션에 저장될 수 있는 형태는 객체만! => int -> Integer 라는 Wrapper 클래스 이용하여 저장해야함.
	 *  
	 *  TreeSet<Integer>
	 *  -> Integer는 Comparable 인터페이스를 이미 상속되어있음 -> 바로 사용 가능! (자동 정렬됨)
	 */
	public void method4() {
