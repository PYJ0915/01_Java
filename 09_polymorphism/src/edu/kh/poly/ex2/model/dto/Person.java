...
public class Person extends Animal {
	...
	// -> 반드시 구현해야만 하는 상속받은 추상 메서드가 있다
	// -> Animal이 가진 추상 메서드 eat(), breath(), move()를 전부 상속받은 Person이
	// -> 본인에게 맞게끔 오버라이딩(재정의) 해라! (강제화)
	...
	@Override
	public void eat() {
		System.out.println("숟가락 젓가락 도구를 이용하여 먹는다");
		
	}

	@Override
	public void breath() {
		System.out.println("코나 입으로 숨을 쉰다");
