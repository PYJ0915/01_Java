...
public class User {
	...
	public User(String userId, String userPw) {
		...
		userGender = '남';
		// this 참조변수
		// - 객체가 자가자신을 참조할 수 있도록 하는 변수
		// 왜 사용?
		// 필드명과 매개변수명이 같은 경우 이를 구분하기 위해 사용!
		
	}
 
	// 매개변수 생성자 자동 완성 == alt + s -> Generate Constructor using fields...
	...
	public User(int userAge) {
		// 매개변수의 개수가 같은 생성자는 있으나 타입이 같은 생성자 없음 - > 오버로딩 성립
	}
	...
	public User(int userAge, String userId) {
		// 매개변수의 개수와 타입은 같지만 순서가 다름 -> 오버로딩 성립
	}
	
	/* public User(int age, String name) {
		// 매개변수의 개수와 타입, 순서가 모두 같아서 오버로딩 성립 불가 -> 변수명은 신경쓰지 않는다!
	} */
	
	
	/* 생성자(Constructor)
	
	  - new 연산자를 통해서 객체를 생성할 때 생성된 객체의 필드값 초기화 + 지정된 기능 수행 역할
	 ...
	 *** 생성자가 하나도 없을 때 컴파일러가 기본생성자를 만들어 줌
